...
ST.ContentView = Marionette.ItemView.extend({

    template: JST['gh-pages/assets/js/templates/pages/home/main.jst']
...
ST.HeaderView = Marionette.CompositeView.extend({

    template: JST['gh-pages/assets/js/templates/header/main.jst']
