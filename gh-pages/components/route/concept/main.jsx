		...
		return (
			<div className='content__inner'>
				...
				<div className='static'>
					...
					<p>ripsaw builds these complex shapes based on mere 5 control points. A slight change in the arrangement of these points produces significant changes in the geometry, which is understood and customized easily by anyone.</p>
											
					<img src="public/images/concept/img-03.svg" />
					<img src="public/images/concept/img-04.svg" />

					<p>The mathematical concept (in this case, a city Voronoi diagram) does the hard work of generating the shape, keeping the user's focus on usability and aesthetics.</p>
